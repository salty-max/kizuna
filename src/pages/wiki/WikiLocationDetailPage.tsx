    ...
    return (
      <div className="scroll-slim min-h-0 flex-1 overflow-y-auto">
        <Panel title={t("wiki.locations")}>
          ...
          <Link to="/wiki/locations" className="mt-3 inline-block text-sm text-bolt-400">
            {t("wiki.backToList")}
          </Link>
        </Panel>
      </div>
  ...
  return (
    <div className="scroll-slim min-h-0 flex-1 overflow-y-auto">
      <div className="mb-2 flex flex-wrap items-center gap-2 text-xs">
        ...
        <Link to="/wiki/locations" className="text-ink-500 no-underline hover:text-bolt-400">
          {t("wiki.locations")}
        </Link>
        <span className="text-ink-700">/</span>
