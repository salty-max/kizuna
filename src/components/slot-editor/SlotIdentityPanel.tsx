...
export function SlotIdentityPanel({
  ...
  return (
    <>
          ...
          <div className="flex items-start gap-3">
            <div className="relative shrink-0">
              ...
              <CharacterModelButton
                ...
                className="absolute -right-1 -bottom-1 size-7 border-2 border-ink-800 bg-ink-900"
              />
            </div>
                    ...
                    <Select
                      ...
                      onChange={(next) => {
                        ...
                        const passives = assignment.passives.map((row) => {
                          ...
                          const passive = dataset.passives.find(
                            (item) => item.id === row.passiveId,
                          );
      ...
      {modelOpen && slot.player && (
        <CharacterModelViewer
          name={displayName}
          imageBase={dataset.imageBase}
          modelStem={slot.player.modelStem}
          characterId={slot.player.characterId}
